...
insBg = pygame.image.load('insbg2.jpg') # resize graphic
insBg = pygame.transform.scale(insBg, (dispWidth, dispHeight))

roadBg = pygame.image.load('background.png')
roadBg = pygame.transform.scale(roadBg, (dispWidth, dispHeight))
...
###############################################################################
###############################################################################
carImg = pygame.image.load("diablo.png") # resize graphic
carImg = pygame.transform.scale(carImg, (60, 100)) 
carImg = carImg.convert_alpha() # remove whitespace from graphic

car2 = pygame.image.load("aventador.png") # resize graphic
car2 = pygame.transform.scale(car2, (60, 100)) # remove whitespace from graphic
